...
public class withdrawamount extends HttpServlet
{
  public void doGet(HttpServletRequest request,HttpServletResponse response)throws ServletException,IOException
  {
    try
	{
	System.out.println("withdrawamount get function called at server");
...
query.append("0,").append(html_withdraw_amount).append(",'").append(html_remark).append("')");
...
/*   
    //command to compile index.java open cmd type below command, cmd must point to d:\Tomcat\webapps\bank\WEB-INF\classes
      javac -cp '.;D:/Tomcat/lib/servlet-api.jar;D:/Tomcat/lib/jsp-api.jar' withdrawamount.java
*/